...
const get_contract_transfers = async (address, toBlock = null) => {
    ...
    let params = [{"address": address, "fromBlock": '0x0', "topics": [transfer_hash]}]
    if(toBlock){
...
module.exports = {
    takeSnapshot:  async (address, toBlock = null) => {
...
//console.log(await takeSnapshot("0x86db8fc255d46aa692dbc2050c4a26c1ce61711e"))
